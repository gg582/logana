...
#define LOGANA_COERCION_MAX_TRACKED_KEYS 128
#define LOGANA_COERCION_MAX_HISTOGRAM_BUCKETS 16384
#define LOGANA_COERCION_MAX_STRING_LEN     1024
#define LOGANA_COERCION_MAX_OVERFLOW_LEN   524288
#define LOGANA_COERCION_INITIAL_ROW_CAP    8192
