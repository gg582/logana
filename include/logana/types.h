...
#define LOGANA_MAX_ROWS 50000000
#define LOGANA_MAX_DIMENSIONS 128
#define LOGANA_MAX_BATCH_JOBS 65536
#define LOGANA_MAX_JOBS 1048576
#define LOGANA_MAX_PAYLOAD_LINES 2000000
#define LOGANA_MAX_PAYLOAD_BYTES (1024 * 1024 * 1024)
...
#define LOGANA_MAX_AUTO_CACHE 8192
